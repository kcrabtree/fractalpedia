<nav x-data="{ open: false }" class="bg-white border-b-2 border-gray-200">
    {{-- Primary Nav Menu --}}
    <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 md:pt-4 lg:pt-6">
...
{{--                                    <div>{{ Auth::user() ? Auth::user()->name : 'Keith'}}</div>--}}
...
{{--                        </x-dropdown>--}}
{{--                    @else--}}
{{--                        <a href="{{ route('login') }}" class="md:text-sm lg:text-base text-gray-500 hover:text-indigo-500">Log in</a>--}}

{{--                        @if (Route::has('register'))--}}
{{--                            <a href="{{ route('register') }}" class="ml-4 md:text-sm lg:text-base text-gray-500 hover:text-indigo-500">Register</a>--}}
{{--                        @endif--}}
{{--                    @endauth--}}
{{--                </div>--}}
{{--            </div> --}}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('model.index')" :active="request()->routeIs('model.index')">
                {{ __('Amp Models') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('cabs')" :active="request()->routeIs('cabs')">
                {{ __('Cabinet IRs') }}
            </x-responsive-nav-link>
